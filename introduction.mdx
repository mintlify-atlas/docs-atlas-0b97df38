...
<Steps>
  ...
  <Step title="Customize & Extend">
    Explore the [API documentation](/api) to customize the UI, handle events, and add advanced features.
  </Step>
</Steps>
...
<Note>
  Looking to run Excalidraw locally for development? Check out our [Development Guide](/development) instead of this installation guide.
</Note>
